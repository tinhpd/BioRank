...
from BioRank.matrix_creation.convex_combination_aggregation_matrix_creation import ConvexCombinationMatrixAggregationCreation
from BioRank.personalization_vector_creation.default_personalization_vector_creation import DefaultPersonalizationVectorCreation
from BioRank.personalization_vector_creation.biological_personalization_vector_creation import BiologicalPersonalizationVectorCreation
from BioRank.personalization_vector_creation.topological_personalization_vector_creation import TopologicalPersonalizationVectorCreation
...
class BioRankCancerGeneRanking():
    ...
    def __init__(self,
        ...
        print("Time for Exectuting BioRank", time.perf_counter() - t0)
