...
file_A_path = r"C:\Users\ASUS\OneDrive - Hanoi University of Science and Technology\Documents\2024.1\Research Bio\Compare result Pagerank\BRW_result_STAD.csv"
file_A1_path = r"C:\Users\ASUS\OneDrive - Hanoi University of Science and Technology\Documents\2024.1\Research Bio\Compare result Pagerank\ORI_result_STAD.csv"
file_A2_path = r"C:\Users\ASUS\OneDrive - Hanoi University of Science and Technology\Documents\2024.1\Research Bio\Compare result Pagerank\BIO_STAD.csv"
...
# In kết quả
print(f"Recall@100 for THCA with PR_Goc: {recall_A1:.4f}, Số lượng gene trùng: {common_A1}, nDCG@100: {ndcg_A1:.4f}")
